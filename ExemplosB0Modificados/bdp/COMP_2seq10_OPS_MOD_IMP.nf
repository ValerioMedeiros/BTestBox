...
THEORY InheritedEnvX IS
  VisibleVariables(Implementation(COMP_2seq10_OPS_MOD_IMP))==(Type(check_BECOME) == Mvv(btype(INTEGER,?,?));Type(check_BLOCK) == Mvv(btype(INTEGER,?,?));Type(check_CASE) == Mvv(btype(INTEGER,?,?));Type(check_IF) == Mvv(btype(INTEGER,?,?));Type(check_OPER_CALL) == Mvv(btype(INTEGER,?,?));Type(check_SEQUENCE) == Mvv(btype(INTEGER,?,?));Type(check_WHILE) == Mvv(btype(INTEGER,?,?));Type(check_boolexp) == Mvv(btype(BOOL,?,?));Type(cond1) == Mvv(btype(BOOL,?,?));Type(counter) == Mvv(btype(INTEGER,?,?));Type(max_counter) == Mvv(btype(INTEGER,?,?)));
  Operations(Implementation(COMP_2seq10_OPS_MOD_IMP))==(Type(ID00002) == Cst(No_type,No_type);Type(ID00001) == Cst(No_type,No_type);Type(ID00000) == Cst(No_type,No_type))
END
&
THEORY ListVisibleStaticX END
&
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(COMP_2seq10_OPS_MOD_IMP)) == (? | ? | ? | ? | ID00000,ID00001,ID00002 | ? | ? | ? | COMP_2seq10_OPS_MOD_IMP);
  List_Of_HiddenCst_Ids(Implementation(COMP_2seq10_OPS_MOD_IMP)) == (? | ?);
  List_Of_VisibleCst_Ids(Implementation(COMP_2seq10_OPS_MOD_IMP)) == (?);
  List_Of_VisibleVar_Ids(Implementation(COMP_2seq10_OPS_MOD_IMP)) == (max_counter,counter,cond1,check_boolexp,check_WHILE,check_SEQUENCE,check_OPER_CALL,check_IF,check_CASE,check_BLOCK,check_BECOME | ?);
  List_Of_Ids_SeenBNU(Implementation(COMP_2seq10_OPS_MOD_IMP)) == (?: ?)
END
&
THEORY VisibleVariablesEnvX IS
  VisibleVariables(Implementation(COMP_2seq10_OPS_MOD_IMP)) == (Type(max_counter) == Mvv(btype(INTEGER,?,?));Type(counter) == Mvv(btype(INTEGER,?,?));Type(cond1) == Mvv(btype(BOOL,?,?));Type(check_boolexp) == Mvv(btype(BOOL,?,?));Type(check_WHILE) == Mvv(btype(INTEGER,?,?));Type(check_SEQUENCE) == Mvv(btype(INTEGER,?,?));Type(check_OPER_CALL) == Mvv(btype(INTEGER,?,?));Type(check_IF) == Mvv(btype(INTEGER,?,?));Type(check_CASE) == Mvv(btype(INTEGER,?,?));Type(check_BLOCK) == Mvv(btype(INTEGER,?,?));Type(check_BECOME) == Mvv(btype(INTEGER,?,?)))
END
&
THEORY TCIntRdX IS
  predB0 == OK;
...
THEORY ListLocalOperationsX IS
  List_Local_Operations(Implementation(COMP_2seq10_OPS_MOD_IMP))==(?)
END
&
...
THEORY TypingPredicateX IS
  TypingPredicate(Implementation(COMP_2seq10_OPS_MOD_IMP))==(check_BECOME: INTEGER & check_BLOCK: INTEGER & check_CASE: INTEGER & check_IF: INTEGER & check_OPER_CALL: INTEGER & check_SEQUENCE: INTEGER & check_WHILE: INTEGER & check_boolexp: BOOL & cond1: BOOL & counter: INTEGER & max_counter: INTEGER)
END
&
