...
def CodeCoverage(operationImp, operationMch, paths, inputs, operationname, nodeStatus, importedMch, seesMch, impName, directory, atelierBDir):
    '''
    ...
    while(len(aux) != 0 and covered == False):
        ...
        ExistValues, inVariables, outVariables, userVariables = makePredicateCodeCoverage(operationImp, operationMch, aux[pathToCover],
                                                                                          ...
                                                                                          importedMch, seesMch, impName, directory, atelierBDir) #Finding the predicate
        if ExistValues:
...
def BranchCoverage(operationImp, operationMch, branchesPaths, branchStatus, paths, inputs, operationname, importedMch, seesMch, impName, directory, atelierBDir):
    '''
...
def PathCoverage(operationImp, operationMch, paths, inputs, operationname, importedMch, seesMch, impName, directory, atelierBDir):
    '''
    ...
    while(len(aux) != 0 and covered == True):
        covered, inVariables, outVariables, userVariables = makePredicatePathCoverage(operationImp, operationMch, aux[pathToCover],
                                                                                      ...
                                                                                      atelierBDir) #Finding the predicate
        if covered:
            allInVariables.append(inVariables)
            allOutVariables.append(outVariables)
            allUserVariables.append(userVariables)
...
def makePredicateBranchCoverage(operationImp, operationMch, path, branchStatus, branchesPaths, pathToCover, inputs, operationName, importedMch, seesMch, impName, directory, atelierBDir):
    '''
...
def makePredicatePathCoverage(operationImp, operationMch, path, pathToCover, inputs, operationName, importedMch, seesMch, impName, directory, atelierBDir):
    '''
...
def makePredicateCodeCoverage(operationImp, operationMch, path, pathToCover, inputs, operationName, nodeStatus, importedMch, seesMch, impName, directory, atelierBDir):
    '''
