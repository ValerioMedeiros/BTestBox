...
class Griding:
    def __init__(self, raiz):
        ...
        self.senha = Entry(self.raiz, width=5, fg='darkgray', show='l', font=('Wingdings', '10'))
    ...
    def okButtonClicked(self):
        ...
        rcode, output, errors = executeSubWithReturn('\"' + atelier_directory + os.sep + 'bbin' + os.sep + "win32" + os.sep + 'BTestBox.exe' +
                                                     '\" \"' + self.currentLanguage.get() +
                                                     '\" \"' + self.currentProfile.get() +
                                                     '\" \"' + self.currentCriteria.get() + ' Coverage' +
                                                     '\" \"' + atelier_directory +
                                                     ...
                                                     '\" \"' + self.chosenCompiler.get() +
                                                     '\" \"' + self.probcliPath.get() + '\"',
                                                     "Starting BTestBox", True)
        print(rcode, output, errors)
